    ...
    for (const i in list) {
      ...
      if (subtext) {
        ...
        ctx.writeScalableText(text, TEXT_X, POSITION_Y - 5, WIDTH - TEXT_X - LIST_MARGIN_X,
          '%S%px "Montserrat Black, ArialUnicode"', 40)
      }
    }
